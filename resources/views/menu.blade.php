...
<div class="sidenav">
    ...
    <a href="{{asset('/')}}"><i class='fab fa-accessible-icon'></i> <span>Aktualności</span></a>
    <a href="{{asset('/splits')}}"><i class='fab fa-accessible-icon'></i> <span>Splity</span></a>
    <a href="{{asset('/ads')}}"><i class='fas fa-info'></i><i class="fa fa-info-circle"></i> <span>Ogłoszenia</span></a>
