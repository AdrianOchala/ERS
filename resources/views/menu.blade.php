...
<div class="sidenav">
    ...
    <a href="{{asset('/')}}"><i class='fas fa-info'></i> <span>Aktualności</span></a>
    ...
    <a href="{{asset('/ersGreen')}}"><i class='far fa-folder-open'></i> <span>Archiwum</span></a>
...
<div class="sidenav__mobile">
    ...
    <a href="{{asset('/ersGreen')}}">Archiwum</a>
